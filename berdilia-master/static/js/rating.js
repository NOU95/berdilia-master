        ...
        if ((rating && rating.length !== 0) && (feedback && feedback.length !== 0)) {
            $.ajax({
                ...
                success: function(data) {
                    var message = getFeedbackMessage("Merci ! Votre commentaire a été enregistré.", "Success");
            ...
            var message = getFeedbackMessage("Veuillez ajouter une note et un message .", "warning");
            $("#feedback-ack").html(message);
        }
    });
